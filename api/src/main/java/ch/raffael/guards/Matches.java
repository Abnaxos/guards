...
@Documented
@Guard(message = "Value must match %s")
public @interface Matches {
    ...
    /**
     * If `true`, use {@link java.util.regex.Matcher#find() find()} instead of
    ...
    class Checker extends Guard.Checker<Matches> {

        private final Pattern pattern;

        public Checker(Matches annotation, Guard.Type type, Class<?> valueType) {
