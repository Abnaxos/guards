 ...
 */
public abstract class IntUnboxingChecker<T extends Annotation> extends Guard.Checker<T> {

    protected IntUnboxingChecker(T annotation, Guard.Type checkType, Class<?> valueType) {
