 ...
 */
public abstract class FloatUnboxingChecker<T extends Annotation> extends Guard.Checker<T> {

    protected FloatUnboxingChecker(T annotation, Guard.Type checkType, Class<?> valueType) {
